...
public class ActiveDirectory {
    ...
    private final static String[] userAttributes = {
    ...
    //*************************************************************************/
    /**
     * * Used to authenticate a user given a username/password and domain
     * name.Provides an option to identify a specific a Active Directory server.
     *
     * @param username
     * @param password
     * @param domainName
    ...
    public static class User {
        ...
        /**
         * * Used to change the user password.Throws an IOException if the
         * Domain Controller is not LDAPS enabled.
         *
         * @param oldPass
         * @param newPass
